 ...
 * *Arquivo: "main.c"*
 ...
 ## Descrição 
  Para a cena gráfica desenvolvida nos tópicos anteriores (aeroporto), acrescente o recurso de iluminação com ao menos UMA fonte luminosa. Devem ser entregues: código fonte, bibliotecas, arquivo de textura, captura da tela da cena com textura e iluminação

 ### Explicação
  Esse exercício foi um pouco mais simples que o o exercício anterior, isto é, colocar o código de uma fonte luminosa foi relativamente mais fácil, porém, quebramos a cabeça para atingir um resultado satisfatório, ou seja, para que a iluminação se comportasse de fato como deveria.
 ...
 ### Prints da cena:
 | Sem iluminaçao | Com iluminação | Com Zoom Iluminação da Torre | 
 | ----------------------------------------------- | ----------------------------------------------- | --------------------------------------------- | 
 | ![img-1](assets/images/aeroporto-texture.png) | ![img-1](assets/images/aeroporto-iluminacao.png) | ![img-2](assets/images/aeroporto-iluminacao-torre.png) | 
