...
Para o projeto final da disciplina de Computação Gráfica (ST765), a dupla optou por seguir em frente com o projeto utilizando o OpenGL, pois não possuíamos experiência com Blender ou outro *software* complexo de computação gráfica. Desse modo, o objetivo deste projeto final foi:

> **Objetivo:** Inserir animações no projeto Aeroporto desenvolvido no OpenGL ao longo do semestre.
...
Obviamente, nos _prints_ abaixo não dá para ver com clareza a animação, logo, **[clique aqui](https://drive.google.com/file/d/1erXqOlNlF30kluBqwxOkATF-7DXGnz7R/view?usp=sharing)** para acessar o vídeo com a animação, hospedado no Google Drive.
...
Esta seção contempla a evolução da cena gráfica ao longo do semestre. No começo havia apenas a modelagem sólida dos objetos, logo após inseriu-se a textura, como também, a iluminação distante (SOL) e por fim, como última alteração foi inserida a animação dos aviões e do radar. **[Clique aqui](https://drive.google.com/file/d/1erXqOlNlF30kluBqwxOkATF-7DXGnz7R/view?usp=sharing)** para acessar o vídeo da animação.
